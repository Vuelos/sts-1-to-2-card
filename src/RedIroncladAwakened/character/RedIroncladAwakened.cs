...
namespace sts1to2card.src.RedIroncladAwakened.character
{
    public class RedIroncladAwakened : PlaceholderCharacterModel
    {
        ...
        public override string CustomCharacterSelectBg => "res://images/scenes/red_ironclad_awakened_portrait.tscn";
        
     	public override string CustomCharacterSelectIconPath => "res://images/scenes/red_ironclad_awakened_button.png";

	    public override string CustomIconTexturePath => "res://images/scenes/red_ironclad_awakened_button.png";
