    ...
    public class BlueDefectCardPool : CustomCardPoolModel
    {
        ...
        protected override CardModel[] GenerateAllCards()
        {
            return new CardModel[]
            {
				...
				// ModelDb.Card<BlueRecursion>(),         
				ModelDb.Card<Stack>(),         
				// ModelDb.Card<BlueSteamBarrier>(),                
				// ModelDb.Card<BlueStreamline>(),        
				ModelDb.Card<SweepingBeam>(),        
				ModelDb.Card<Turbo>(),             
				// ModelDb.Card<BlueAggregate>(),        
				// ModelDb.Card<BlueAutoShields>(),          
				// ModelDb.Card<BlueBlizzard>(),           
				ModelDb.Card<BootSequence>(),            
				// ModelDb.Card<BlueBullseye>(),          
				ModelDb.Card<Capacitor>(),            
				ModelDb.Card<Chaos>(),         
				ModelDb.Card<Chill>(),      
				// ModelDb.Card<BlueConsume>(),            
				ModelDb.Card<Darkness>(),             
				ModelDb.Card<Defragment>(),          
				// ModelDb.Card<BlueDoomAndGloom>(),           
				ModelDb.Card<DoubleEnergy>(),        
				ModelDb.Card<Equilibrium>(),        
				ModelDb.Card<Ftl>(),        
				// ModelDb.Card<BlueForceField>(),            
				ModelDb.Card<Fusion>(),            
				ModelDb.Card<GeneticAlgorithm>(),              
				ModelDb.Card<Glacier>(),              
				// ModelDb.Card<BlueHeatsinks>(),               
				ModelDb.Card<HelloWorld>(),        
				ModelDb.Card<Loop>(),        
				// ModelDb.Card<BlueMelter>(),         
				ModelDb.Card<Overclock>(),    
				        
				// ModelDb.Card<Recycle>(),           
				// ModelDb.Card<ReinforcedBody>(),     
				// ModelDb.Card<Reprogram>(),       
